...
class DataFlowProfileController extends Controller
{
    /**
     * @var array
     */
    ...
    public function update($id)
    {
        $this->validate(request(), [
            'name'                => ['required', 'unique:bulkupload_data_flow_profiles,name,' . $id, new \Webkul\Core\Contracts\Validations\Code],
            'attribute_family_id' => 'required'
        ]);
