...
@section('content')
    ...
    <div class="import-new-products mt-45 ms-15">
        <div class="heading mb-25">
            <h1>{{ __('bulkupload::app.admin.bulk-upload.bulk-product-importer.add-profile') }}</h1>
        </div>

        <form
            method="POST"
            action="{{ route('admin.bulk-upload.bulk-product-importer.add') }}"
        ...
        >
            ...
            <div class="control-group" :class="[errors.has('name') ? 'has-error' : '' ]">
                ...
                <input type="text" v-validate="'required'" class="control" name="name" value="" data-vv-as="&quot;{{ __('bulkupload::app.admin.bulk-upload.bulk-product-importer.name') }}&quot;"/>
    ...
    <accordian :title="'{{ __('bulkupload::app.admin.bulk-upload.bulk-product-importer.grid') }}'" :active="true" class="mt-45">
        <div slot="body">
